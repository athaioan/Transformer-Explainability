...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", required=False, default=r'C:\Users\georg\PycharmProjects\Transformer-Explainability\ours\psa\vgg_cls.pth', type=str)
    parser.add_argument("--network", default="ours.psa.network.vgg16_cls", type=str)
    parser.add_argument("--infer_list", default="voc12/val.txt", type=str)
    parser.add_argument("--num_workers", default=8, type=int)
    parser.add_argument("--voc12_root", required=False, default=r'C:\Users\georg\Documents\KTH_ML_Master\Deep Learning Advanced Course\Project\Datasets\VOCdevkit\VOC2012', type=str)
